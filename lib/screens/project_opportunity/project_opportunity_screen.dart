...
import 'package:positive_metering/screens/project_opportunity/bidder/view_bidder_screen.dart';
import 'package:positive_metering/screens/project_opportunity/project_contact/project_contact_screen.dart';
      ...
      appBar: CommonAppBar(
        ...
        onAddTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => ProjectContactScreen(
